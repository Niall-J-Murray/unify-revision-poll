...
import { FiHome, FiUser, FiSettings, FiLogOut, FiMenu, FiX, FiMoon, FiSun, FiBell } from "react-icons/fi";
...
export default function DashboardLayout({ children, title }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-github-bg dark:bg-github-dark-bg text-github-fg dark:text-github-dark-fg">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-github-bg dark:bg-github-dark-hover border border-github-border dark:border-github-dark-border rounded-md shadow-lg z-30">
              <div className="p-2 border-b border-github-border dark:border-github-dark-border">
                ...
                <p className="text-xs text-github-secondary dark:text-github-dark-secondary truncate">{user?.email}</p>
              </div>
              <div className="p-1">
                <button
                  onClick={toggleTheme}
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-10 w-64 bg-github-bg dark:bg-github-dark-bg border-r border-github-border dark:border-github-dark-border transform ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      } lg:translate-x-0 transition-transform duration-300 ease-in-out`}>
        <div className="h-full flex flex-col">
          {/* Logo */}
          <div className="p-6 border-b border-github-border dark:border-github-dark-border">
            <h2 className="text-2xl font-bold text-github-primary dark:text-github-dark-primary">SecureAuth</h2>
          </div>
                  ...
                  {dropdownOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-github-bg dark:bg-github-dark-hover border border-github-border dark:border-github-dark-border rounded-md shadow-lg z-30">
                      ...
                      <div className="p-1">
                        <Link
                          href="/profile"
                          className="block px-3 py-2 text-sm rounded-md hover:bg-github-hover dark:hover:bg-github-dark-border flex items-center"
